...
import { closeQuickStart, toggleOpenQuickStartOnStartup } from "./quickStartSlice";
...
const QuickStart = (props: Props) => {
    ...
    const [openOnStartup, setOpenOnStartup] = useState(localStorage.getItem("openQuickStartOnStartup") === "true")
    ...
    function handleOpenOnStartup() {
        dispatch(toggleOpenQuickStartOnStartup())
        setOpenOnStartup(localStorage.getItem("openQuickStartOnStartup") === "true")
    }
